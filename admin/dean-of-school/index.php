        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="container-fluid">
                ...
                <td>
                <?php if($request_dept_instance[$key]['role_id'] != 7): 
                  if($request_dept_instance[$key]['hod_id'] == null ){ echo '<span title="This Request hasn\'t reacted from previous level (departement)"=>Not reacted</span>';}
                  else{
                    if($request_dept_instance[$key]['hod_sansation'] == 1){ echo '<span class="">approved</span>'; }
                    if($request_dept_instance[$key]['hod_sansation'] == 2){ echo '<span class="">disapproved</span>'; }
                  }
                endif; ?>
                </td>
                <td>
                <?php 
                if($request_dept_instance[$key]["dean_sansation"] == 2){echo '<span class="bg-warning">Disapproved</span>';}

                if($request_dept_instance[$key]["dean_sansation"] == 1){echo '<span class="bg-success">Approved</span>';}
?>
                <?php  if($request_dept_instance[$key]["Dean_id"] == null) : ?> 
            ...
            <td >
            <input data-target="#Request-view-details" req-id="<?php echo htmlentities($request_dept_instance[$key]["req_id"]) ?>" style="margin: 0px ;padding: 3px;" type="button" class="btn btn-info btn-glow dean-view-staff-request-details" value="View" data-toggle="modal" > 
...
<!-- <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog ">
    ...
    <!-- request details preview start -->
       ...
       <div  style="z-index:9999" id="Request-view-details" class="container-fluid modal modal-adminpro-general fullwidth-popup-InformationproModal " role="dialog">
...
$('#table').on('click', '.do-action-button', function(){
          ...
          //  console.log(staf_id +" " +reqId);
                ...
                success:function(data){
                  ...
                  {
                    let message = '<h4 class="bg-success" > This Request '+data_formulated.all_about_request.dean_sansation == 1 || data_formulated.all_about_request.dean_sansation == true? " Approved " : " Disapproved" +'</h4>'
   ...
   function Dean_Do_direct_ActionOnRequest(){
    ...
    if(dean_comment == null || dean_comment == ""){
      errors_array.push("comment field can't be empty");
    }
    if(dean_sansation == null || dean_sansation == "")
    {
    ...
    $.post("action-on-request/dean-action-on-request.php",{req_id: req_id,dean_comment: dean_comment, dean_sansation: dean_sansation, dean_id:dean_id},
    function(data) {
      console.log(data);
    ...
    var supervisor_id  = <?php echo $staff_principal_details[0]['stf_id'] ?>;
