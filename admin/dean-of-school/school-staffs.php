...
include('../Classes/Report_class.php');
  ...
  $staffs_in_school = $staff->getAllStaff_in_school($schl_id);
     // instantiate reports
    //  $report = new Report();
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="container-fluid">
                ...
                $cnt=1;
                if(!empty($staffs_in_school)):
                foreach($staffs_in_school as $key => $value):
                   ?>

                <tr>
                <td></td>
                <!-- <td><?php// echo htmlentities($cont_rows);?></td> -->
                <td><?php echo htmlentities($staffs_in_school[$key]["stf_id"]);?></td>                
                <td><?php echo htmlentities($staffs_in_school[$key]["stf_fname"]);?></td>
                <td><?php echo htmlentities($staffs_in_school[$key]["stf_lname"]);?></td>
                <td><?php echo htmlentities($staffs_in_school[$key]["role_name"]);?></td>
                <td><?php echo htmlentities($staffs_in_school[$key]["nb_of_request_per_staff"]);?></td>
                <td>
                <input staff-id="<?php echo htmlentities($staffs_in_school[$key]["stf_id"]);  ?>" type="button" class="btn-sm border-0 current-staff-status <?php echo $staffs_in_school[$key]['statuses'] == 1 ? 'btn-success': 'btn-warning'; ?>" value="<?php echo $staffs_in_school[$key]['statuses'] == 1 ? 'Active': 'Disactive'; ?>" />
