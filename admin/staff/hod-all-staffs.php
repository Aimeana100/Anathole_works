...
$sql ="SELECT staffs_info.stf_id as stf_id, staffs_info.stf_fname as stf_fname, staffs_info.stf_lname as stf_lname, roles.role_name as role_id, departements.dept_name as dept_name, staffs_info.statuses as statuses FROM staffs_info INNER JOIN departements ON departements.dept_id = staffs_info.dept_id AND departements.dept_id = :departement INNER JOIN roles ON staffs_info.role_id = roles.role_id;";
...
foreach($results as $result):
   ...
   <td>
   <!--  <a href="request-details.php?Rid=<?php echo htmlentities($result->req_id);?>&hodId=<?php echo $_SESSION['hod_id']; ?>">
      <button type="button" class="btn btn-info btn-min-width btn-glow mr-1 mb-1"></button> -->
    </a>
