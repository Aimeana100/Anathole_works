    ...
    <div  class="main-menu-content">
      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
       ...
       if(isset($staff_details)) {
        ...
        <li class=" nav-item"><a href="depertement-staffs.php"><i class="la la-envelope"></i><span class="menu-title" data-i18n="nav.dash.main">Dept Staffs</span></a>
        </li>

        <li class=" nav-item"><a href="depertement-reports.php"><i class="la la-envelope"></i><span class="menu-title" data-i18n="nav.dash.main">Dept reports</span></a>
        </li>
        ...
        <li class=" nav-item"><a href="hod-inbox-requests.php"><i class="la la-envelope"></i><span class="menu-title" data-i18n="nav.dash.main">My Requests</span></a>
        </li>
        <li class=" nav-item"><a href="hod-inbox-reports.php"><i class="la la-envelope"></i><span class="menu-title" data-i18n="nav.dash.main">My reports</span></a>
        </li>
