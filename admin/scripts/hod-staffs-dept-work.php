              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    ...
                    ?>
                    <h3 class="info">
                    <?php echo htmlentities($Pending_requests_number);?></h3>
...
// if(($request_dept_instance[$key]["hod_sansation"] != 1) AND ($request_dept_instance[$key]["role_id"] != 7)){
  $approved_requests[$key] = $request_dept_instance;
  $cnt++;
// }
}
...
foreach($staffs_in_dept as $key => $value):
      ?>
                  ...
                  <td><?php echo htmlentities($staffs_in_dept[$key]["role_id"]);?></td>
                  <td><?php echo htmlentities($staffs_in_dept[$key]["nb_of_request_per_staff"]);?></td>

   <td>
   <!--  <a href="request-details.php?Rid=<?php //echo htmlentities($staffs_in_dept[$key]["stf_id"]));?>&hodId=<?php echo $HOD_id; ?>">
