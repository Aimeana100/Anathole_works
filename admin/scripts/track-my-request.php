 ...
 {    
  ...
  // include('Classes/Notification_class.php');
        ...
        if(isset($request_details))
      {
        ...
        $request_status = array("hod_reacted"=> isset($hod_id) ? true:false, "dean_reacted"=> isset($dean_id) ? true:false, "principal_reacted"=> isset($principal_id) ? true:false, "about_hod_reacted" => [ "id" =>isset($which_hod_acted_on_request) ? $which_hod_acted_on_request[0]["stf_id"] : null, "fname" => isset($which_hod_acted_on_request) ? $which_hod_acted_on_request[0]["stf_fname"] : null, "lname" => isset($which_hod_acted_on_request) ? $which_hod_acted_on_request[0]["stf_lname"] : null], "about_dean_reacted" => [ "id" =>isset($which_dean_acted_on_request) ? $which_dean_acted_on_request[0]["stf_id"] : null, "fname" =>isset($which_dean_acted_on_request) ? $which_dean_acted_on_request[0]["stf_fname"] : null, "lname" => isset($which_dean_acted_on_request) ? $which_dean_acted_on_request[0]["stf_lname"] : null],  "about_principal_reacted" => [ "id" => isset($which_principal_acted_on_request) ? $which_principal_acted_on_request[0]["stf_id"] : null, "fname" => isset($which_principal_acted_on_request) ? $which_principal_acted_on_request[0]["stf_fname"] : null, "lname" => isset($which_principal_acted_on_request) ? $which_principal_acted_on_request[0]["stf_lname"] : null], "all_about_request" =>$request_details[0] );
