      ...
      <div class="navbar-header">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="admin-principal.php">
          ...
          <i class="toggle-icon ft-toggle-rihght font-medium-3 white" data-ticon="ft-toggle-right"></i></a></li>
                  ...
                  <a  data-target="#Request-view-details" class="view-request-details" data-toggle="modal" req-id="<?php echo htmlentities($request_instance[$key]["req_id"]) ?>" href="javascript:void(0)">
                    <div class="media">
                      ...
                      <h6 class="media-heading">
                        ...
                        <p class="notification-text font-small-3 text-muted">
                       <a data-target="#Request-view-details" req-id="<?php echo htmlentities($request_instance[$key]["req_id"]) ?>" href="javascript:void(0)" class="btn m-0 view-request-details" data-toggle="modal" > <?php echo htmlentities($request_instance[$key]["req_id"]);?></a> <span> waiting next Approval </span>
                      </p>
                        <small>
